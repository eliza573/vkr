...
const KimExercise = () => {
  ...
  // ОДНА функция для перетаскивания (Шаг 1)
  ...
  // ОДНА универсальная функция для клика по буквам (Шаг 2 и 3)
  ...
  // Логика для выпадающих списков (Шаг 4 и 5)
  ...
  // Хендлеры для Drag & Drop (Шаг 1 и Шаг 6)
      ...
      <div className="kim-ex-layout">
        ...
        <h2 className="ex1-title">Ким? Эмне?/ көнүгүү</h2>
         ...
         <div className="ex-header-banner">
          ...
          {/* ШАГ 6: Сопоставление (Ваш новый код) */}
          {step === 6 && (
